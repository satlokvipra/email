...
@section('content')
      ...
      <div class="row">
        <div class="col-md-12">
           <form method="POST" action="{{ route('admin.sesserver.post') }}" enctype="multipart/form-data">
            @csrf
          <div class="box">
                      ...
                      <div class="box-body">
                       <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="ses_key" class="form-control" id="exampleInputPassword1" placeholder="Host Name">
                        </div>
                        <div class="form-group">
